...
const About = () => {
    return (
        <>
        <p>
            <i><strong>point-intercept</strong></i> is a field-to-database application that employs the line-point-intercept method for measuring ecological characteristics of a habitat.
            <br/>
            <br/>
